...
##### 1. Configure the esp-hosted slave target

Open menuconfig and enter the corresponding configuration options to set ESP32C5 as the slave target.
...
>[!NOTE]
>Pay attention to the pin configuration.
